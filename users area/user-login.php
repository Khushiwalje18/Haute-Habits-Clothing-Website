...
<body>
    <div class="container-fluid">
        ...
        <h5 style="color:rgb(19,61,31);  margin-left:10%; margin-bottom:25px">User Login:</h5>
        <div class="row" style="margin-left:10%;">   
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" >
                    ...
                    <div class="mt-4 pt-2" >
                        <input type="submit" value="Login" style="background-color:smokewhite; color:rgb(19,61,31);" class="py-2 px-3 border-0" name="user_login">
                        <p class="small fw-bold mt-2 pt-1">Don't have an account ? <a href="user-registration.php" class="text-danger">Register</a></p>
                    </div>
                </form>
            </div>
        </div>
