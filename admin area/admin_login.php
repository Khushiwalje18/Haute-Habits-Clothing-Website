...
<body >
    <div class="container-fluid m-3">
        <h2 class="text-center mb-5" style="color:rgb(19,61,31);">Admin Login</h2>
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-lg-6 col-xl-4">
                <form action="" method="post">
                    ...
                    <div>
                        <input type="submit" name="admin_login" value="Login" style="background-color:rgb(19,61,31); color:white;" class="py-2 px-3 border-0">
...
<?php
    if(isset($_POST['admin_login'])){
        ...
        $select_query="SELECT * FROM `admin_details` WHERE admin_username='$admin_username'";
